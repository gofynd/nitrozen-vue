<template>
  <div id="app">
    <div class="main-div">
      ...
      <nitrozen-header></nitrozen-header>
...
import NitrozenRadio from "./../components/NRadio";
import NitrozenCheckbox from "./../components/NCheckbox"
export default {
  name: "App",
  components:{'nitrozen-toggle-btn' : NitrozenButton,NitrozenRadio,NitrozenCheckbox},
  data() {
    return {
